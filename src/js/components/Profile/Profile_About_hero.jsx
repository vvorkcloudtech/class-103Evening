...
class Profile_About_hero extends Component{
    render () {
        ...
        return (
            <div>
                        ...
                        <h5 style={{ paddingTop: '15px' }}><strong></strong></h5>
                        <Profile_Navbar/>
                        <hr />

                        <h5 style={{ paddingTop: '15px' }}>I'M WEB DESIGNER</h5>
...
export default Profile_About_hero;
